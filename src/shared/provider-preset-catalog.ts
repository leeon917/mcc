...
export interface ProviderPresetDefinition {
  ...
  /** Default thinking intensity; undefined ⇒ 'high' (thinking on). */
...
const RAW_PROVIDER_PRESET_DEFINITIONS: readonly ProviderPresetDefinition[] = [
  ...
  },
  {
    id: 'km',
    name: 'Kimi',
    description: 'Moonshot AI - K2.7 Code (thinking always on)',
  ...
  },
  {
    id: 'mm',
    name: 'MiniMax',
    description: 'M2.1/M2.1-lightning/M2 — multilingual coding (1M context)',
  ...
  },
  {
    id: 'deepseek',
    name: 'DeepSeek',
    description: 'V4-Pro / V4-Flash — multimodal (text + vision), 1M context',
  ...
  {
    id: 'qwen',
    name: 'Qwen (DashScope 通义)',
    description: '阿里云 DashScope OpenAI 兼容，旗舰思考模型 qwen3-max',
    baseUrl: 'https://dashscope.aliyuncs.com/compatible-mode/v1',
    defaultProfileName: 'qwen',
    defaultModel: 'qwen3-max-2026-01-23',
    opusModel: 'qwen3-max-2026-01-23',
    sonnetModel: 'qwen3-max-2026-01-23',
    haikuModel: 'qwen3-max-2026-01-23',
    reasoningEffort: 'max',
    apiKeyPlaceholder: 'sk-...',
  ...
  },
  {
    id: 'xiaomi-mimo',
    name: '小米 MiMo',
    description: 'MiMo V2.5-Pro（旗舰，1M 上下文，思考默认开启），Anthropic 兼容',
